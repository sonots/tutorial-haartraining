# -nonsym option for haartraining
...
perl createtrainsamples.pl pie_positives.dat negatives.dat pie_tests \
...
./haartraining -data haarcascade_frontalface_pie2 -vec pie_samples.vec -bg negatives.dat -nstages 20 -nsplits 2 -minhitrate 0.999 -maxfalsealarm 0.5 -npos 7000 -nneg `cat negatives.dat | wc -l` -w 18 -h 20 -mem 800 -mode ALL -nonsym
./performance -data haarcascade_frontalface_pie2.xml -info pie_tests.dat -ni
