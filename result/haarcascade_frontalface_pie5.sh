...
./haartraining -data haarcascade_frontalface_pie3 -vec pie_samples.vec -bg negatives.dat -nstages 20 -nsplits 2 -minhitrate 0.999 -maxfalsealarm 0.5 -npos 10000 -nneg `cat negatives.dat | wc -l` -w 18 -h 20 -mem 800 -mode ALL -sym
